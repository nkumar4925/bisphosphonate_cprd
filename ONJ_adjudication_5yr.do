*******************************************************
* ONJ_adjudication_5yr.do
* Extracted ONJ adjudication logic (5-year follow-up)
*
* Notes:
...
* ---------- STRONG ----------
* HES ICD
use "cohorts\bispho5yr_hes.dta", clear
...
* HES OPCS
use "cohorts\bispho5yr_hes_opcs.dta", clear
...
use "cohorts\bispho5yr_obs_cut.dta", clear
...
use "cohorts\bispho5yr_prod_cut.dta", clear
...
save "onj_potential_5yr.dta", replace
...
save "onj_final_5yr.dta", replace
